...
class _HomePageState extends State<HomePage> {
                ...
                BlocBuilder<EventCubit, EventState>(
                  builder: (context, state) {
                    if (state is EventError) {
                      ...
                      return _listPopularEvent(_filterEvents(state.events));
                    } else {
                ...
                BlocBuilder<EventCubit, EventState>(
                  builder: (context, state) {
                    if (state is EventError) {
                      ...
                      return _listEventThisMonth(_filterEvents(state.events));
                    } else {
                      return const Center(child: CircularProgressIndicator());
                    }
                  },
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Row(children: [
                  Image.asset('assets/images/app_icon.png', width: 16),
  ...
  _buildSearch(BuildContext context) => GestureDetector(
        onTap: () {
        ...
        child: Container(
          ...
          child: Row(
            children: const [
              Icon(Icons.search, color: AppColors.greyTextColor, size: 20),
              SizedBox(width: 8),
              Text(
                "Search events, locations, categories...",
                style: TextStyle(
                    color: AppColors.greyTextColor, fontWeight: FontWeight.w400, fontSize: 13),
              )
            ],
          ),
        ),
